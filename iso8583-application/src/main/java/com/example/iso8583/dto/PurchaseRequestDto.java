 ...
 * automaticamente um encoder/decoder de mensagens ISO 8583.
 */
@Iso8583Message(mti = "0210")
public class PurchaseRequestDto {
	...
	public PurchaseRequestDto(String primaryAccountNumber, String processingCode,
		...
		this.localTransactionTime = LocalTime.now();
		this.localTransactionDate = LocalDate.now();
	}
	...
	public LocalTime getLocalTransactionTime() {
		return localTransactionTime;
	}

	public void setLocalTransactionTime(LocalTime localTransactionTime) {
		this.localTransactionTime = localTransactionTime;
	}

	public LocalDate getLocalTransactionDate() {
		return localTransactionDate;
	}

	public void setLocalTransactionDate(LocalDate localTransactionDate) {
